...
public class Menus extends PApplet {
    ...
    void drawGameOver() {
        ...
        fill(220, 120, 120);
        stroke(255);
        rect(width / 2 - 25, height / 2, 50, 25);
        fill(255);
        textAlign(CENTER);
        ...
        fill(220, 120, 120);
        stroke(255);
        rect(width / 2 - 25, height / 2 + 32, 50, 25);
        fill(255);
        textAlign(CENTER);
        text("Menu", width / 2, height / 2 + 49);
    ...
    public void mousePressed() {
        if (currentState == GameState.RUNNING) {
            ...
            if (mouseX > (width / 2 - 25) && mouseX < (width / 2 + 25) && mouseY > height / 2 && mouseY < (height / 2 + 25)) {
                currentState = GameState.RUNNING;
            }
            if (mouseX > (width / 2 - 25) && mouseX < (width / 2 + 25) && mouseY > height / 2 + 30 && mouseY < (height / 2 + 55)) {
                currentState = GameState.START;
            }
        }
    }
